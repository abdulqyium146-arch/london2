...
import { generateLocalBusinessSchema, generateFAQSchema, generateBreadcrumbSchema, generateWebPageSchema } from '@/lib/seo/schema'
...
export default async function LocationPage({ params }: Props) {
  ...
  const locationUrl = `${BUSINESS.website}/locations/${location.slug}`
  const schemas = [
    ...
    generateWebPageSchema(location.metaTitle, location.metaDescription, locationUrl),
  ]
