...
export default async function LocationPage({ params }: Props) {
  ...
  const locationPostcodes = postcodes.filter((p) =>
    location.postcodes.includes(p.code)
  )
  ...
  const locationFaqs: FAQ[] = [
    ...
    },
    {
      ...
      answer: `Yes. We provide full coverage of ${location.name} including all ${location.postcodes.join(', ')} postcodes. Whether you're in the town centre near ${location.stations[0]} or in the residential streets further out, we can reach you quickly.`,
    },
    {
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {location.stations.map((station) => (
                        <span key={station} className="text-xs px-2.5 py-1 rounded-full bg-gray-800 text-slate-300">
                          {station}
                        </span>
                      ))}
                    </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-4 text-slate-300 leading-relaxed">
              ...
              <p>
                ...
                security upgrades in residential streets around {location.stations[0]}, we&apos;re your
                trusted local security partner.
              </p>
            </div>

            {/* Emergency Services in this location */}
            <div className="mt-10">
                ...
                {emergencyServices.map((service) => (
                  ...
                  >
                    <div>
                      ...
                      <div className="text-xs text-slate-500 mt-0.5">{service.responseTime} · From £{service.priceFrom}</div>
                    </div>
