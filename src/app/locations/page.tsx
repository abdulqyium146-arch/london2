...
const PAGE_URL = `${SEO.siteUrl}/locations`
...
export default function LocationsPage() {
  const schemas = [
    generateWebPageSchema(
      'Locksmith London Locations — All Areas Covered',
      'London Locksmith Pro covers all 32 London boroughs. Find your nearest locksmith in East, North, South, and West London. 24/7 emergency service.',
      PAGE_URL,
      'CollectionPage'
    ),
    generateItemListSchema(
      'London Locksmith Coverage Areas',
      PAGE_URL,
      locations.map((loc) => ({
        name: `Locksmith ${loc.name}`,
        url: `${SEO.siteUrl}/locations/${loc.slug}`,
